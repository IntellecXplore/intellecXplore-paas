...
DROP SEQUENCE IF EXISTS "public"."business_merchant_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."business_orders_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."business_payments_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."business_refund_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."merchant_payment_configs_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."monitor_job_job_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_api_api_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_dept_dept_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_dict_data_dict_code_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_dict_type_dict_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_ip_black_ip_black_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_login_log_log_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_menu_btn_btn_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_menu_menu_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_oper_log_oper_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_role_role_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_storage_storage_id_seq" CASCADE;
DROP SEQUENCE IF EXISTS "public"."system_user_user_id_seq" CASCADE;
DROP TABLE IF EXISTS "public"."business_merchant" CASCADE;
DROP TABLE IF EXISTS "public"."business_merchant_configs" CASCADE;
DROP TABLE IF EXISTS "public"."business_orders" CASCADE;
DROP TABLE IF EXISTS "public"."business_payments" CASCADE;
DROP TABLE IF EXISTS "public"."business_refund" CASCADE;
DROP TABLE IF EXISTS "public"."monitor_job" CASCADE;
DROP TABLE IF EXISTS "public"."system_api" CASCADE;
DROP TABLE IF EXISTS "public"."system_dept" CASCADE;
DROP TABLE IF EXISTS "public"."system_dict_data" CASCADE;
DROP TABLE IF EXISTS "public"."system_dict_type" CASCADE;
DROP TABLE IF EXISTS "public"."system_ip_black" CASCADE;
DROP TABLE IF EXISTS "public"."system_login_log" CASCADE;
DROP TABLE IF EXISTS "public"."system_menu" CASCADE;
DROP TABLE IF EXISTS "public"."system_menu_btn" CASCADE;
DROP TABLE IF EXISTS "public"."system_oper_log" CASCADE;
DROP TABLE IF EXISTS "public"."system_role" CASCADE;
DROP TABLE IF EXISTS "public"."system_role_menu" CASCADE;
DROP TABLE IF EXISTS "public"."system_storage" CASCADE;
DROP TABLE IF EXISTS "public"."system_user" CASCADE;
DROP TABLE IF EXISTS "public"."system_user_role" CASCADE;
...
BEGIN;
LOCK TABLE "public"."system_menu" IN SHARE MODE;
INSERT INTO "public"."system_menu" ("menu_id","path","name","component","title","icon","show_badge","show_text_badge","is_hide","is_hide_tab","link","is_iframe","keep_alive","fixed_tab","create_time","create_by","update_time","update_by","del_flag","remark","active_path","sort","parent_id","status","is_full_page") VALUES (37, 'metadata', 'Metadata', '/system/metadata/collection', '元数据管理', 'ri:database-2-line', 'f', NULL, 'f', 'f', NULL, 'f', 't', 'f', now(), NULL, NULL, NULL, 'f', NULL, NULL, 10, 3, 't', 'f'),(38, 'collection', 'MetadataCollection', '/system/metadata/collection', '数据表管理', 'ri:table-line', 'f', NULL, 'f', 'f', NULL, 'f', 't', 'f', now(), NULL, NULL, NULL, 'f', NULL, NULL, 0, 37, 't', 'f')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."system_menu_btn" IN SHARE MODE;
INSERT INTO "public"."system_menu_btn" ("menu_id","sort","title","permission","create_time","create_by","update_time","update_by","del_flag","remark","btn_id","status") VALUES (37, 0, '新增', 'system:metadata:collection:create', now(), NULL, NULL, NULL, 'f', NULL, 61, 't'),(37, 0, '查询', 'system:metadata:collection:query', now(), NULL, NULL, NULL, 'f', NULL, 62, 't'),(37, 0, '编辑', 'system:metadata:collection:update', now(), NULL, NULL, NULL, 'f', NULL, 63, 't'),(37, 0, '删除', 'system:metadata:collection:delete', now(), NULL, NULL, NULL, 'f', NULL, 64, 't'),(38, 0, '新增', 'system:metadata:field:create', now(), NULL, NULL, NULL, 'f', NULL, 65, 't'),(38, 0, '查询', 'system:metadata:field:query', now(), NULL, NULL, NULL, 'f', NULL, 66, 't'),(38, 0, '编辑', 'system:metadata:field:update', now(), NULL, NULL, NULL, 'f', NULL, 67, 't'),(38, 0, '删除', 'system:metadata:field:delete', now(), NULL, NULL, NULL, 'f', NULL, 68, 't')
;
COMMIT;
BEGIN;
LOCK TABLE "public"."system_role_menu" IN SHARE MODE;
INSERT INTO "public"."system_role_menu" ("role_id","menu_id","menu_btn_id") VALUES (1, 37, NULL),(1, 38, NULL),(1, 37, 61),(1, 37, 62),(1, 37, 63),(1, 37, 64),(1, 38, 65),(1, 38, 66),(1, 38, 67),(1, 38, 68)
;
COMMIT;
...
SELECT setval('"system_menu_btn_btn_id_seq"', 68, true);
