...
const AuthModule: IRouteModule = {
    ...
    routes: [
        ...
        { url: '/auth/tenants', method: 'get', summary: '获取可访问租户列表', handle: getTenantList, meta: { isAuth: true } },
        { url: '/auth/switch-tenant', method: 'post', summary: '切换租户', dto: SwitchTenantDto, handle: switchTenant, meta: { isAuth: true } },
    ]
};
